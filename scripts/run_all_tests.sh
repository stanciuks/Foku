...
echo "1/6 Running DeterministicRuleEngine tests..."
scripts/run_rule_engine_tests.sh
echo ""

echo "2/6 Running SubjectTagEngine tests..."
scripts/run_subject_tag_engine_tests.sh
echo ""

echo "3/6 Running AchievementEngine tests..."
scripts/run_achievement_engine_tests.sh
echo ""

echo "4/6 Running FeatureAccessEngine tests..."
scripts/run_feature_access_engine_tests.sh
echo ""

echo "5/6 Running StudySummaryExportEngine tests..."
scripts/run_study_summary_export_tests.sh
echo ""

echo "6/6 Running app build check..."
xcodebuild \
